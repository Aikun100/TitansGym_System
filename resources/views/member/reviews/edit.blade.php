...
@section('title', 'Edit Review - GymSystem')
...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <form action="{{ route('member.reviews.update', $review) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center space-x-2">
                        <div class="star-rating flex space-x-1">
                            @for($i = 1; $i <= 5; $i++)
                                <button type="button" 
                                        class="star-btn text-4xl focus:outline-none transition-all duration-200 {{ $review->rating >= $i ? 'text-yellow-400' : 'text-gray-300' }}" 
                                        data-rating="{{ $i }}"
                                        onclick="setRating({{ $i }})">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="review" 
                              ...
                              placeholder="Share your experience with this trainer...">{{ old('review', $review->review) }}</textarea>
            ...
            <div class="mt-6 pt-6 border-t border-gray-200">
                <form action="{{ route('member.reviews.destroy', $review) }}" 
                      method="POST" 
...
<script>
    ...
    ratingText.textContent = ratingLabels[{{ $review->rating }}];
</script>
@endsection
