                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="date" 
                               ...
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition">
                        <p class="text-xs text-gray-500 mt-1">You must be at least 13 years old</p>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="membership_type" 
                                id="membership_type"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition">
                            <option value="basic" {{ old('membership_type', auth()->user()->membership_type) == 'basic' ? 'selected' : '' }}>Basic Plan</option>
                            <option value="premium" {{ old('membership_type', auth()->user()->membership_type) == 'premium' ? 'selected' : '' }}>Premium Plan</option>
                            <option value="vip" {{ old('membership_type', auth()->user()->membership_type) == 'vip' ? 'selected' : '' }}>VIP Access</option>
                        </select>
                    </div>
