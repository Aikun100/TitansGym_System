    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">View and track your personalized workout routines</p>
            </div>
        </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between text-sm p-2 rounded-lg bg-white bg-opacity-40">
                                <span class="text-gray-500"><i class="fas fa-user-tie mr-2 text-blue-500"></i>Trainer</span>
                                <span class="font-semibold text-gray-900">{{ $plan->trainer->name }}</span>
                            </div>
                            <div class="flex justify-between text-sm p-2 rounded-lg bg-white bg-opacity-40">
                            ...
                            <div class="flex justify-between text-sm p-2 rounded-lg bg-white bg-opacity-40">
                                <span class="text-gray-500"><i class="fas fa-check-circle mr-2 text-green-500"></i>Status</span>
                                @if($plan->execution_status === 'executed')
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800 flex items-center">
                                        <i class="fas fa-check mr-1"></i> Executed
                                    </span>
                                @else
                        ...
                        <div class="mt-6 pt-4 border-t border-gray-200 border-opacity-50 flex justify-between items-center">
                            ...
                            <a href="{{ route('member.workout-plans.show', $plan) }}" 
        ...
        @else
            <div class="text-center py-16 glass-card rounded-xl">
                <div class="bg-gradient-to-br from-orange-100 to-red-200 rounded-full p-6 w-24 h-24 flex items-center justify-center mx-auto mb-4 shadow-inner">
                    <i class="fas fa-dumbbell text-4xl text-orange-600"></i>
                </div>
                <h3 class="text-xl font-bold text-gray-900 mb-2">No workout plans assigned yet</h3>
                <p class="text-gray-600 mb-8 max-w-md mx-auto">
                    Your trainer hasn't created any workout plans for you yet. Contact your trainer to get started with a personalized routine.
                </p>
            </div>
        @endif
    </div>
